...
class Footer extends Component {
    render() {
        return (          
            <section className="footer pt-120 dark-bg-light">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="copyright">
                                    <p>@ 2021-Copyright reserved to BooHunt.Proudly Crafted by <Link to="https://themeforest.net/user/Himanshu Sharma">Himanshu Sharma</Link> </p>
                                </div>
                            </div>
                        </div>
                    </div>
